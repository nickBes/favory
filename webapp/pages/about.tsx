        ...
        <>
            <article className={styles.article}>    
                ...
                <section className={styles.articleSection}>
                    ...
                    <div>
                        <p><i>פייבורי</i> התחיל כצוות פיתוח קטן של שלושה תלמידי תיכון ישראליים. הרגשנו שרכישת מחשבים נייחים וניידים הייתה מסובכת מדי כיוון שהמון אנשים מתבלבלים בין כל האפשרויות השונות והמפרטים הטכניים המוזרים.</p>
